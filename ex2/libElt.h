...
/**
 * \fn void initialiserElt(elt_t *e, size_t nbSousElts)
 ...
 * \param nbSousElts Le nombre de sous éléments de l'élément.
 * \attention Ne pas utiliser cette sous fonction pour des structures simples ou des types natifs.
